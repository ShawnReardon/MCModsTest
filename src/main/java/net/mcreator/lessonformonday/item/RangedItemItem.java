...
import net.mcreator.lessonformonday.procedures.RangedItemRangedItemUsedProcedure;
...
public class RangedItemItem extends LessonformondayModElements.ModElement {
	@ObjectHolder("lessonformonday:ranged_item")
	public static final Item block = null;
	@ObjectHolder("lessonformonday:entitybulletranged_item")
	public static final EntityType arrow = null;
	public RangedItemItem(LessonformondayModElements instance) {
		super(instance, 4);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletranged_item").setRegistryName("entitybulletranged_item"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						RangedItemRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(LaserItemItem.block, (int) (1));
		}
