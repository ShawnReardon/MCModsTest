...
import net.mcreator.lessonformonday.procedures.ThrowableTNTBulletHitsBlockProcedure;
...
public class ThrowableTNTItem extends LessonformondayModElements.ModElement {
	@ObjectHolder("lessonformonday:throwable_tnt")
	public static final Item block = null;
	@ObjectHolder("lessonformonday:entitybulletthrowable_tnt")
	public static final EntityType arrow = null;
	public ThrowableTNTItem(LessonformondayModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletthrowable_tnt").setRegistryName("entitybulletthrowable_tnt"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				ThrowableTNTBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
