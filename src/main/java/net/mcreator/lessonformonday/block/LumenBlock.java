...
import net.mcreator.lessonformonday.procedures.TheBrainPlantDestroyedProcedure;
...
public class LumenBlock extends LessonformondayModElements.ModElement {
	@ObjectHolder("lessonformonday:lumen")
	public static final Block block = null;
	public LumenBlock(LessonformondayModElements instance) {
		super(instance, 27);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).lightValue(2));
			setRegistryName("lumen");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				TheBrainPlantDestroyedProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
